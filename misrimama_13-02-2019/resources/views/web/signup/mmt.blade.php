    ...
    <div class="container">
       ...
       <p>Fill out the form to become service provider</p>
        ...
        <ul class="nav nav-tabs">
            <li ><a   href="{{ route('spf-register') }}"><center> (ESP)</center>
            ...
            <li ><a  href="{{ route('fsp-register') }}"><center>(FSP)</center> 
                ...
                <li class="active"><a   href="{{ route('mmt-register') }}"> <center>(MMT)</center>
                    <br><span class="label label-info">Means individual or self employed technician.</span></a>
                </li>
        ...
        <div class="tab-content">
            <div id="esp" class="tab-pane fade in active">
                <form class="espform booking_form" action="{{url('add_mmt')}}" id="espform" method="post" enctype="multipart/form-data">
@csrf
                            ...
                            return false;
                              ...
                              inputPrice = $(this).val();
                                ...
                                if(isNaN(serviceCategory) || isNaN(inputPrice)){
                                    ...
                                    $(this).parents('tr').find('.s_comm').val(inputPrice);

                                   // commission = (((100-serviceCategory)*inputPrice) / 100).toFixed(2);
                                    $(this).parents('tr').find('.s_desp').val(0.00);
                                }
                                //console.log(perc);
                        }
