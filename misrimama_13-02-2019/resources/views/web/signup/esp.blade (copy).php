...
@section('css')
    ...
    <style>
        ...
        @media(max-width: 768px){
            ...
            .form-group div,.panel{
                padding:0;        
            }
            
            .panel-body div,.panel div{
                padding-left:1%;
                padding-right:1%;
            }
            .stima div{
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input  value="+88" type="text" name="phone_no" id='phone_no' class="form-control required-entry456 phonecon"   pattern="^(?:\+88)?(?:\d{11}|\d{11})$" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-6 col-md-6  ">
                                        ...
                                        <input  id="aphn" type="number" name="alt_ph" class="form-control"  pattern="^(?:\+88)?(?:\d{11}|\d{11})$"  />
                                ...
                                <div class="panel-body ragun">
                                    ...
                                    <div class="form-group stima">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            ...
                                            id="select2_cat" name="cats[]" multiple="multiple" onchange="service_typer(this);">
                                                <option value="#">--select--</option>
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="+88" name="mfs_account" id='mfs_account' class="form-control required-entry456 phonecon" onblur="checkpattern()" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 col-md-6  ">
                                                    ...
                                                    <input  type="text" name="c_phone_no[]" id='c_phone_no' class="form-control required-entry456 phonecon" value="+88"   pattern="^(?:\+88)?(?:\d{11}|\d{11})$"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="c_alt_phone_no[]" class="form-control"   pattern="^(?:\+88)?(?:\d{11}|\d{11})$" /></div>
                                            <div class="form-group">
                                                <div class="col-sm-6 col-md-6  ">
                    ...
                    <div class="col-sm-4 col-md-4  ">
                        ...
                        <table class="table table-hover" id="participantTable">
                            ...
                            <tr class="participantRow">
                                <td>
                                    <select class="form-control sc_id " name="sc_id[]" onchange="calculateservice()">
                                        {{--@foreach($cat as $c)
                                ...
                                </td>    <td><input name="s_price[]"  type="text" value="" id="s_price1">
                                <td><input name="s_comm[]" id="c_price1" type="text" placeholder="price" class="required-entry s_comm">
                                <td><input name="s_desp[]" id="d_price1" type="text" placeholder="price" class="required-entry s_desp">
                                </td>
                    ...
                    <fieldset >
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-md-6  ">
                                            ...
                                            <label for="name">Phone number: <span class="required">*</span></label>
                                            <input  value="+88" type="text" name="phone_no" class="form-control required-entry456 phonecon"    pattern="^(?:\+88)?(?:\d{11}|\d{11})$"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-6 col-md-6  ">
                                            ...
                                            <label for="name">Alternate phone number: </label>
                                            <input  id="aphn" type="number" name="alt_ph" class="form-control"  />
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-6 col-md-6 blusithi" style="margin-left:-22px">
                                        ...
                                        <div class="col-sm-6 col-md-6 blusithi" style="right:-43px">
                        ...
                        <table class="table table-hover" id="fspparticipantTable">
                            ...
                            <tr class="fspparticipantRow">
                                ...
                                </td>    <td><input name="s_price[]" id="" type="number" placeholder="price" value="" class="required-entry fs_price">
                                <td><input name="s_comm[]" id="" type="number" placeholder="price" value="" class="required-entry fs_comm">
                                <td><input name="s_desp[]" id="" type="number" placeholder="price" value="" class="required-entry fs_desp">
                                </td>
...
@csrf
    ...
    <script type="text/javascript">
        ...
        function service_typer(ths){
            
         var val=$(ths).val();
          
          alert($("#participantRow").length);
          
            if($("#participantTable tr").length ==3){
                
                var cont=$(ths).find('option[value="' + val + '"]').html();
                var option="<option value='"+val+"'>"+cont+"</option>";
                $("#participantTable tr").find('select').html(option);
                ...
                var splited=val.slip(',');
                var option="";
                
                jQuery.each( "#participantTable tr", function( i, val ) {
                    
                    var cont=$(ths).find('option[value="' + val[i] + '"]').html();
                    
                    var option="<option value='"+val[i]+"'>"+cont+"</option>";
     ...
     /*   $(function(){
        ...
        var value = $("#mobile_banking").val();
            ...
            if(value=="Rocket")
            {
            var regex =/^(?:\+88)?(?:\d{11}|\d{12})$/;
            
            
            if(regex.test($('#mfs_account').val()))
            {

                $('#regex').closest('.form-group').addClass('has-success');
            }
            
               //$('#mfx_account').setCustomValidity("Dude  is not a valid email. Enter something nice!!");   
                
            }
         
            else{
                var regex2 =/^(?:\+88)?(?:\d{11}|\d{11})$/;
                if(regex2.test($('#mfs_account').val()))
            {
                   $('#regex2').closest('.form-group').addClass('has-error');
            }
            }        
        ...
        {
            var value = $("#select2_cat").val();
            var value1 = $('.sc_id').val();
            var value2 = 100-value;
             $.ajax({
                 type: "GET",
                 url: '{{ url('searchpricecat') }}',
                 data:{value1},
                 success:function(data){
                       var value3= (data.data);

                       var value4=(value3*value)/100;
