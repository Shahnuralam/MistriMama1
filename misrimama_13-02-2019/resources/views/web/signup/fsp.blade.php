    ...
    <div class="container">
       ...
       <p>Fill out the form to become service provider</p>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a  href="{{ route('fsp-register') }}"><center>(FSP)</center> 
        ...
        <div class="tab-content">
            <div id="esp" class="tab-pane fade in active">
                <form class="espform booking_form" action="{{url('add_fsp')}}" id="espform" method="post" enctype="multipart/form-data">
@csrf
